...
import { sendProfessionalMessageAction } from "./actions";
    ...
    <main className="min-h-screen bg-slate-100 text-slate-950">
      <section className="bg-blue-600 px-6 py-10 text-white">
        <div className="mx-auto flex max-w-4xl flex-col gap-5 md:flex-row md:items-start md:justify-between">
          <div>
            ...
            <h1 className="mt-3 text-3xl font-extrabold">{clientName}</h1>
      ...
      <section className="mx-auto max-w-4xl px-6 py-8">
        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <form action={sendProfessionalMessageAction} className="mt-6">
